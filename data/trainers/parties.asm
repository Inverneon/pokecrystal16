...
PryceGroup:
	...
	db 15
	dw SWINUB
	dw MUD_SLAP, ICY_WIND
	db 15
	dw SEEL
	dw WATER_GUN, ICY_WIND, HORN_ATTACK
	db 16
	dw SMOOCHUM
	dw ICY_WIND, CONFUSION, SING
	db -1 ; end
...
ChuckGroup:
	...
	dw PRIMEAPE
	db NO_ITEM
	dw SWAGGER, ROCK_SLIDE, SUBMISSION, PSYCH_UP
	db 33
	dw ELECTABUZZ
	db NO_ITEM
	dw FIRE_PUNCH, LIGHT_SCREEN, THUNDERPUNCH, DYNAMICPUNCH
	db 33
	dw URSARING
	db SCOPE_LENS
	dw SLASH, DYNAMICPUNCH, CRUNCH, REST
	db 34
	dw POLIWRATH
	db LEFTOVERS
	dw HYPNOSIS, ICE_PUNCH, SURF, DYNAMICPUNCH
	db -1 ; end
...
Rival1Group:
	...
	db 24
	dw MAGNETON
	dw SPARK, THUNDER_WAVE, SPIKE_CANNON
	db 24
	dw GOLBAT
	dw LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 24
	dw LARVITAR
	dw ROCK_THROW, DIG, BITE
	db -1 ; end
...
ExecutiveFGroup:
	...
	db 24
	dw GLOOM
	dw MEGA_DRAIN, SYNTHESIS, SLEEP_POWDER, ACID
	db 26
	dw MURKROW
	dw WING_ATTACK, PURSUIT, HAZE, NO_MOVE
	db -1 ; end
