...
Moves1:
	...
	move EFFECT_MULTI_HIT,          25, NORMAL,        100, 10,   0      ;DOUBLESLAP
	move EFFECT_MULTI_HIT,          25, FLYING,        100, 15,   0      ;COMET_PUNCH
	...
	move EFFECT_FLINCH_HIT,         65, FIGHTING,      100, 15,  30      ;ROLLING_KICK
	...
	move EFFECT_TRAP_TARGET,        75, POISON,        100, 20,   0      ;WRAP
	...
	move EFFECT_DEFENSE_DOWN_HIT,   45, FIRE,          100, 30,  10      ;ACID
	...
	move EFFECT_FREEZE_HIT,        120, ICE,            75,  5,  10      ;BLIZZARD
	...
	move EFFECT_LEECH_HIT,          45, GRASS,         100, 20,   0      ;ABSORB
	move EFFECT_LEECH_HIT,          60, GRASS,         100, 10,   0      ;MEGA_DRAIN
	move EFFECT_LEECH_SEED,          0, GRASS,          90, 10,   0      ;LEECH_SEED
	move EFFECT_SP_ATK_UP,           0, NORMAL,        100, 40,   0      ;GROWTH
	move EFFECT_NORMAL_HIT,         55, GRASS,         100, 25,   0      ;RAZOR_LEAF
	...
	move EFFECT_SPEED_DOWN,          0, BUG,           100, 40,   0      ;STRING_SHOT
	move EFFECT_STATIC_DAMAGE,      40, DRAGON,        100, 10,   0      ;DRAGON_RAGE
	move EFFECT_TRAP_TARGET,        45, FIRE,          100, 15,   0      ;FIRE_SPIN
	...
	move EFFECT_BATON_PASS,          0, NORMAL,        100, 20,   0      ;SMOKESCREEN
	...
	move EFFECT_SPEED_DOWN_HIT,     40, GROUND,        100, 10, 100      ;MUD_SLAP
	move EFFECT_ACCURACY_DOWN_HIT,  65, WATER,          85, 10,  50      ;OCTAZOOKA
	move EFFECT_SPIKES,              0, GROUND,        100, 20,   0      ;SPIKES
	move EFFECT_PARALYZE_HIT,      120, ELECTRIC,       75,  5, 100      ;ZAP_CANNON
	...
	move EFFECT_MULTI_HIT,          25, GROUND,        100, 10,   0      ;BONE_RUSH
	...
	move EFFECT_LEECH_HIT,          75, GRASS,         100, 15,   0      ;GIGA_DRAIN
	...
	move EFFECT_DEFENSE_UP_HIT,     75, STEEL,         100, 25,  10      ;STEEL_WING
	...
	move EFFECT_REVERSAL,            1, DARK,          100, 20,   0      ;FRUSTRATION
	...
	move EFFECT_PARALYZE_HIT,       65, DRAGON,        100, 20,  30      ;DRAGONBREATH
	...
	move EFFECT_DEFENSE_DOWN_HIT,  120, STEEL,          85, 15,  30      ;IRON_TAIL
	move EFFECT_ATTACK_UP_HIT,      50, STEEL,         100, 35,  50      ;METAL_CLAW
	move EFFECT_ALWAYS_HIT,         80, FIGHTING,      100, 10,   0      ;VITAL_THROW
	...
	move EFFECT_FUTURE_SIGHT,      120, PSYCHIC_TYPE,  100, 15,   0      ;FUTURE_SIGHT
